...
###############################################################################
%description
  Packaged bootstrap gcc binaries.
...
%files
  ...
  %exclude %{package_install_prefix}/lib
  %exclude %{package_install_prefix}/lib64
  %exclude %{package_install_prefix}/libexec
  %{package_install_prefix}/libexec/gcc/arm-none-eabi/%{version}
